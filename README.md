...
## 本项目获取地址：https://www.bishecode.com/product/107/
...
图5-2 公告信息管理页面【管理员可以对公告信息信息进行添加，修改，删除，查询操作】
![alt text](images/image-4.png)

图5-3 物流信息管理页面【管理员可以对物流信息进行添加，修改，删除，查询操作】
![alt text](images/image-5.png)

图5-4 车辆信息管理页面【管理员可以对车辆信息进行添加，修改，删除操作】
![alt text](images/image-6.png)

图5-5 物流信息页面【用户登录后可以查看物流信息，可以看到物流信息状态和详情】
![alt text](images/image-7.png)

图5-6 运单信息添加页面【用户可以在运单信息管理里面添加运单信息】
